...
from lifeguard.database import init_db, Session
database.init_db()
...
from lifeguard.views.auth import auth_bp
app.register_blueprint(auth_bp)

from lifeguard.views.zone import zone_bp
app.register_blueprint(zone_bp)

from lifeguard.views.cluster import cluster_bp
app.register_blueprint(cluster_bp)

from lifeguard.views.vpool import vpool_bp
app.register_blueprint(vpool_bp)

from lifeguard.views.task import task_bp
app.register_blueprint(task_bp)

from lifeguard.views.testing import testing_bp
